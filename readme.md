...
**We only tested this on Windows. I'm trying to get a Linux version up and running now. The front end currently works, but the back end can be accessed directly, also. You can just use pdf_to_audiobook.py directly to convert the pdf to the audiobook mp3.**
